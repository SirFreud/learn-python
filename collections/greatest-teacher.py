...
'Kenneth Love': ['Python Basics', 'Python Collections', 'Django Basics', 'Django Forms'], 
'Michael Valdez': ['All the cool stuff', 'Making cool shit'], 
'Bob Jones': ['Bob cant teach for shit']
}
